...
<?php } ?>
							...
							<?php } ?>
												...
												<tr><td valign="top" align="left" width="150"><img src="components/com_ezrealty/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<?php echo _EZREALTY_OPENHOUSE_DETAILS; ?></td><td align="center" width="10" valign="top">:</td><td valign="top" align="left"><?php echo $row->ohouse_desc; ?></td></tr>
												<?php } ?>
												<?php if ( $er_usebookings && $row->viewbooking ){ ?>
												<tr><td valign="top" align="left" width="150"><img src="components/com_ezrealty/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<?php echo _EZREALTY_BOOKINGS; ?></td><td align="center" width="10" valign="top">:</td><td valign="top" align="left"><?php echo parseThruBots($row->bookinglink); ?></td></tr>
												<?php } ?>
