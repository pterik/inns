...
<?php if ( $er_useshortlist ){ ?>
		<td>
			<a class="readit" href="javascript:void(0)" onclick="window.open('<?php echo $link5; ?>','win2','<?php echo $status3; ?>');" title="<?php echo _EZREALTY_LISTINGS_ADDLIGHTBOX;?>"><?php echo _EZREALTY_LISTINGS_ADDLIGHTBOX;?></a>
		</td>
<?php } ?>
<td>
<div align="right">
<span><input class="readit" type="button" value="<?php echo _EZREALTY_READMORE;?>" onclick="location.href='<?php echo $link2; ?>'" /></span>
