...
function doButtons2(picimage) {
eval("document['picture2'].src = " + picimage + ".src");
}
//  End -->
...
<table border="0" width="100%">
	<tr>
		<td valign="top" class="h3" colspan="2"><?php if ( $row->unit_num ){ ?><?php echo $row->unit_num;?> <?php } ?><?php if ( $row->street_num ){ ?><?php echo $row->street_num;?> <?php } ?><?php if ( $row->address2 ){ ?><?php echo $row->address2;?>, <?php } ?><?php if ( $row->proploc ){ ?><?php echo $row->proploc;?> <?php } ?><?php if ( $er_usepc && $row->postcode ){ ?><?php echo $row->postcode;?><?php } ?></td>
	</tr>
	<tr>
...
<!--END IMAGE TABLE-->			
			...
			<tr>
				<td valign="top" class="h3"><?php echo $row->adline;?></td>
			</tr>
			<tr>
				<td>
					<div align="center">
						<table border="0" width="95%">
							...
							<tr><td valign="top" align="left" width="150"><img src="components/com_ezrealty/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<?php echo _EZREALTY_DETAILS_BOND;?></td><td align="center" width="10" valign="top">:</td><td valign="top" align="left">
							<?php if ( $er_currencypos==0 ) { ?>
							...
							<?php } ?>
							<tr><td valign="top" align="left" width="150"><img src="components/com_ezrealty/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<?php echo _EZREALTY_CATEGORY_CATNAME;?></td><td align="center" width="10" valign="top">:</td><td valign="top" align="left"><a href="<?php echo $link11; ?>"><?php echo $row->category;?></a></td></tr>
			...
			<tr>
				<td valign="top"><?php if ($row->propdesc) { ?><?php echo parseThruBots(stripslashes($row->propdesc));?><?php } else { ?><?php echo parseThruBots($row->smalldesc);?><?php } ?></td>
			</tr>

			<?php if ( $row->image9 ){ ?>
			<tr>
				<td valign='top'><div align="center"<br /><?php echo _EZREALTY_VIEWDET_FPLANS;?><br /><img src="components/com_ezrealty/<?php echo $er_imagedirectory;?>/<?php echo $row->image9;?>" width="<?php echo $er_imgwidth;?>" border='1' name="picture2" alt="<?php echo _EZREALTY_PIX_HOVER;?>" /></div></td>
			</tr>
			<?php } ?>
				...
				<td>
					<div align="center">
						<table border="0" cellspacing="2" cellpadding="1">
							<tr>
								<?php if ( $row->image10 ){ ?>
								<td valign='top' align='center'><a onmouseover="doButtons2('pic09')" target="_blank" href="components/com_ezrealty/<?php echo $er_imagedirectory;?>/<?php echo $row->image9;?>"><img src="components/com_ezrealty/<?php echo $er_imagedirectory;?><?php if ( $er_thumbcreation !== 'none' ) { ?>/th<?php } ?>/<?php echo $row->image9;?>" width="<?php echo $er_thumbwidth;?>" border="0" alt="<?php echo _EZREALTY_VLDET_IMAGE9;?>" /></a></td>
								<?php }else{ ?>
								<td valign='top' align='center'> </td>
								<?php } if ( $row->image10 ){ ?>
								<td valign='top' align='center'><a onmouseover="doButtons2('pic10')" target="_blank" href="components/com_ezrealty/<?php echo $er_imagedirectory;?>/<?php echo $row->image10;?>"><img src="components/com_ezrealty/<?php echo $er_imagedirectory;?><?php if ( $er_thumbcreation !== 'none' ) { ?>/th<?php } ?>/<?php echo $row->image10;?>" width="<?php echo $er_thumbwidth;?>" border="0" alt="<?php echo _EZREALTY_VLDET_IMAGE10;?>" /></a></td>
								<?php }else{ ?>
								<td valign='top' align='center'> </td>
								<?php } if ( $row->image11 ){ ?>
								<td valign='top' align='center'><a onmouseover="doButtons2('pic11')" target="_blank" href="components/com_ezrealty/<?php echo $er_imagedirectory;?>/<?php echo $row->image11;?>"><img src="components/com_ezrealty/<?php echo $er_imagedirectory;?><?php if ( $er_thumbcreation !== 'none' ) { ?>/th<?php } ?>/<?php echo $row->image11;?>" width="<?php echo $er_thumbwidth;?>" border="0" alt="<?php echo _EZREALTY_VLDET_IMAGE11;?>" /></a></td>
								<?php }else{ ?>
								<td valign='top' align='center'> </td>
								<?php } if ( $row->image12 ){ ?>
								<td valign='top' align='center'><a onmouseover="doButtons2('pic12')" target="_blank" href="components/com_ezrealty/<?php echo $er_imagedirectory;?>/<?php echo $row->image12;?>"><img src="components/com_ezrealty/<?php echo $er_imagedirectory;?><?php if ( $er_thumbcreation !== 'none' ) { ?>/th<?php } ?>/<?php echo $row->image12;?>" width="<?php echo $er_thumbwidth;?>" border="0" alt="<?php echo _EZREALTY_VLDET_IMAGE12;?>" /></a></td>
								<?php }else{ ?>
								<td valign='top' align='center'> </td>
								<?php } ?>
							</tr>
...
<?php if ( $er_usemap && $er_mapsys == 3 && $row->declat && $row->declong ){ ?>
				...
				<tr>
					<td>
										...
										<div align="center">
											<table border="0" width="100%">
										    	<?php if ( $row->age ){ ?>
												<tr><td valign="top" align="left" width="120"><img src="components/com_ezrealty/images/bullet.gif" border="0" width="12" height="12" alt="" />&nbsp;<?php echo _EZREALTY_VIEWDET_AGE;?></td><td align="center" width="10" valign="top">:</td><td valign="top" align="left"><?php echo $row->age;?></td></tr>
												<?php } ?>
										    	<?php if ( $row->landtype ){ ?>
...
<!--START OPEN HOUSE DETAILS-->			

							<table width="100%">
								<tr>
									<td class='sectiontableheader'><?php echo _EZREALTY_OPENHOUSE_DETAILS; ?></td>
								</tr>
								<tr>
									<td>
										<div align="center">
											<table border="0" width="100%">
												<tr valign='top'><td valign="top" align="left"><?php echo $row->ohouse_desc;?></td></tr>
