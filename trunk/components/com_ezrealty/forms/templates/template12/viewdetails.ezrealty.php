...
$status1 = 'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=600,height=400,directories=no,location=no';
...
<!--START SELLER INFORMATION BLOCK-->			
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="0" class="sectiontableentry1" style="border: outset 1px; cursor: hand;" >
		<tr> 
			<td>
			<table border="0" cellspacing="0" cellpadding="1" style="font: 10pt Tahoma;">
					<tr valign="middle"> 
						<td><img src="components/com_ezrealty/images/arrow_down.png" border="0" width="10" height="10" hspace="5" alt="" /></td>
						<td><strong><?php echo _EZREALTY_PROFILE_DSDET;?></strong></td>
						<td> </td>
					</tr>
				</table>
			</td>
...
<?php } ?>
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="0" class="sectiontableentry1" style="border: outset 1px; cursor: hand;" onclick="toggleTab('tools');" >
		<tr> 
			<td>
			<table border="0" cellspacing="0" cellpadding="1" style="font: 10pt Tahoma;">
					<tr valign="middle"> 
						<td><img src="components/com_ezrealty/images/arrow_down.png" border="0" width="10" height="10" hspace="5" alt="" /></td>
						<td><strong><?php echo _EZREALTY_TOOLS;?></strong></td>
						<td><font size='1'>(<?php echo _EZREALTY_CLICK;?>)</font></td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<div id="tools" style="padding: 5px; display: none;">
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="0" class="sectiontableentry1" style="border: outset 1px; cursor: hand;" onclick="toggleTab('specs');" >
		<tr> 
			<td>
			<table border="0" cellspacing="0" cellpadding="1" style="font: 10pt Tahoma;">
					<tr valign="middle"> 
						<td><img src="components/com_ezrealty/images/arrow_down.png" border="0" width="10" height="10" hspace="5" alt="" /></td>
						<td><strong><?php echo _EZREALTY_SPECS;?></strong></td>
						<td><font size='1'>(<?php echo _EZREALTY_CLICK;?>)</font></td>
					</tr>
				</table>
			</td>
	...
	<div id="specs" style="padding: 5px; display: none;">
...
<?php } ?>
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="0" class="sectiontableentry1" style="border: outset 1px; cursor: hand;" onclick="toggleTab('details');" >
		<tr> 
			<td>
			<table border="0" cellspacing="0" cellpadding="1" style="font: 10pt Tahoma;">
					<tr valign="middle"> 
						<td><img src="components/com_ezrealty/images/arrow_down.png" border="0" width="10" height="10" hspace="5" alt="" /></td>
						<td><strong><?php echo _EZREALTY_TABS_DETAILS;?></strong></td>
						<td><font size='1'>(<?php echo _EZREALTY_CLICK;?>)</font></td>
					</tr>
				</table>
			</td>
	...
	<div id="details" style="padding: 5px; display: none;">
...
<?php } else { ?>
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="0" class="sectiontableentry1" style="border: outset 1px; cursor: hand;" onclick="toggleTab('features');" >
		<tr> 
			...
			<table border="0" cellspacing="0" cellpadding="1" style="font: 10pt Tahoma;">
					<tr valign="middle"> 
						<td><img src="components/com_ezrealty/images/arrow_down.png" border="0" width="10" height="10" hspace="5" alt="" /></td>
						<td><strong><?php echo _EZREALTY_TABS_FEATURES;?></strong></td>
						<td><font size='1'>(<?php echo _EZREALTY_CLICK;?>)</font></td>
					</tr>
				</table>
			</td>
	...
	<div id="features" style="padding: 5px; display: none;">
...
<?php if ( $row->openhouse && $row->ohouse_desc ){ ?>
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="0" class="sectiontableentry1" style="border: outset 1px; cursor: hand;" onclick="toggleTab('ohouse');" >
		<tr> 
			<td>
			<table border="0" cellspacing="0" cellpadding="1" style="font: 10pt Tahoma;">
					<tr valign="middle"> 
						<td><img src="components/com_ezrealty/images/arrow_down.png" border="0" width="10" height="10" hspace="5" alt="" /></td>
						<td><strong><?php echo _EZREALTY_OHOUSE;?></strong></td>
						<td><font size='1'>(<?php echo _EZREALTY_CLICK;?>)</font></td>
					</tr>
				</table>
			</td>
	...
	<div id="ohouse" style="padding: 5px; display: none;">
...
<?php } ?>
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="0" class="sectiontableentry1" style="border: outset 1px; cursor: hand;" onclick="toggleTab('video');" >
		<tr> 
			...
			<table border="0" cellspacing="0" cellpadding="1" style="font: 10pt Tahoma;">
					<tr valign="middle"> 
						<td><img src="components/com_ezrealty/images/arrow_down.png" border="0" width="10" height="10" hspace="5" alt="" /></td>
						<td><strong><?php echo _EZREALTY_DETAILS_VIDEOTOUR;?></strong></td>
						<td><font size='1'>(<?php echo _EZREALTY_CLICK;?>)</font></td>
					</tr>
				</table>
			</td>
	...
	<div id="video" style="padding: 5px; display: none;">
	...
	<table width="100%" border="0" cellpadding="1" cellspacing="0" class="sectiontableentry1" style="border: outset 1px; cursor: hand;" >
		<tr> 
			...
			<table border="0" cellspacing="0" cellpadding="1" style="font: 10pt Tahoma;">
					<tr valign="middle"> 
						<td><img src="components/com_ezrealty/images/arrow_down.png" border="0" width="10" height="10" hspace="5" alt="" /></td>
						<td><strong><?php echo _EZREALTY_PROPERTY_MAPLOC;?></strong></td>
						<td> </td>
					</tr>
				</table>
			</td>
