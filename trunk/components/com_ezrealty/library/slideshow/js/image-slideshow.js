	...
	***********************************************************************************************/ 
	...
	function startSlide(e)
	{
		...
		var id = this.id;
		this.getElementsByTagName('IMG')[0].src = 'components/com_ezrealty/library/slideshow/images/' + this.id + '_over.gif';	
	...
	{
		var id = this.id;
		this.getElementsByTagName('IMG')[0].src = 'components/com_ezrealty/library/slideshow/images/' + this.id + '.gif';
		slideSpeed=0;
	}
